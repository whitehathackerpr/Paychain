from sqlalchemy import create_engine, Column, ForeignKey, Integer, String, Float, Boolean, DateTime, Text, Enum, Date, JSON, Table
...
DATABASE_URL = os.getenv("DATABASE_URL", "sqlite:///./paychain.db")
